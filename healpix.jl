...
# ╔═╡ 546239a6-b5be-4077-952a-dae46187df4b
# scatter!(p, [383],[56])

# ╔═╡ 9e15fcc2-59dd-472a-9304-a7e7148c1e58
pix2angRing(Resolution(4), 192)

# ╔═╡ 9941ea4d-29b9-4dae-b62d-b26acf286a6f
mollweideproj(pix2angRing(Resolution(4), 192)...)

# ╔═╡ c9f92c1e-205d-4952-8e15-7f662502e588
# colat in [0, pi], long in [0, 2*pi]
...
begin
	bmpwidth=length(p[1][1][:x])
	bmpheight=length(p[1][1][:y])
end
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "f7478ffbe1c92ed812ba2900b9181622af67982e"
